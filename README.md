...
- azure-app-service
- azure-mysql
urlFragment: azure-fastapi-mysql-flexible-appservice
name: Deploy FastAPI Application with MySQL on Azure App Service (Python)
...
# Deploy FastAPI Application with MySQL via Azure App Service
